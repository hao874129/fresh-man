...
// Photo components
import StudyCardFoto from './StudyCardFoto'

export default function StudyCard({ special }) {
  return (
    <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <Box className="study_card">
      ...
      <Box className="study_card study_card2">
      ...
      <Box className="study_card study_card3">
